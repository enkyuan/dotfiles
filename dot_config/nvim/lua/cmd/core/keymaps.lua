...
map("n", "<Leader>p", '"+p', opts, { desc = "Paste from System Clipboard" })
map("n", "<Leader>P", '"+P', opts, { desc = "Paste Before from System Clipboard" })
...
map({ "n", "v" }, "<Leader>ow", "<cmd>lua require('cmd.core.utils').toggle_option('wrap')<CR>", opts,
	{ desc = "Toggle Wrap" })
map({ "n", "v" }, "<Leader>os", "<cmd>lua require('cmd.core.utils').toggle_option('spell')<CR>", opts,
	{ desc = "Toggle Spell" })
map({ "n", "v" }, "<Leader>on", "<cmd>lua require('cmd.core.utils').toggle_option('number')<CR>", opts,
	{ desc = "Toggle Number" })
map({ "n", "v" }, "<Leader>or", "<cmd>lua require('cmd.core.utils').toggle_option('relativenumber')<CR>", opts,
...
-- LeetCode:
map({ "n", "v" }, "<Leader>Lm", "<cmd>Leet<CR>", opts, { desc = "LeetCode Menu" })
map({ "n", "v" }, "<Leader>Ll", "<cmd>Leet list<CR>", opts, { desc = "Problems List" })
map({ "n", "v" }, "<Leader>Lr", "<cmd>Leet random<CR>", opts, { desc = "Random Problem" })
map({ "n", "v" }, "<Leader>Ld", "<cmd>Leet daily<CR>", opts, { desc = "Daily Problem" })
map({ "n", "v" }, "<Leader>Lt", "<cmd>Leet test<CR>", opts, { desc = "Run Tests" })
map({ "n", "v" }, "<Leader>Ls", "<cmd>Leet submit<CR>", opts, { desc = "Submit Solution" })
map({ "n", "v" }, "<Leader>Lc", "<cmd>Leet console<CR>", opts, { desc = "Open Console" })
map({ "n", "v" }, "<Leader>Li", "<cmd>Leet info<CR>", opts, { desc = "Problem Info" })
map({ "n", "v" }, "<Leader>Lg", "<cmd>Leet lang<CR>", opts, { desc = "Change Language" })
map({ "n", "v" }, "<Leader>LR", "<cmd>Leet reset<CR>", opts, { desc = "Reset Code" })
map({ "n", "v" }, "<Leader>Ly", "<cmd>Leet yank<CR>", opts, { desc = "Yank Solution" })
