local plugins = {
	...
	},
	{
		...
		opts = function ()
			return require("tevim.plugins.configs.leetcode")
		end
	},
	{
	...
	},
	{
		...
		config = function()
			require('render-markdown').setup(require("tevim.plugins.configs.render-markdown"))
		end,
	},
	{
		...
		config = function()
			require("claude-code").setup(require("tevim.plugins.configs.claude"))
		end
	}
}
